...
%ccc_version2_sas(kid_2009_core,kid_2009_core_results,dx,25,pr,15,9)
***************************************************************************************************/
libname data 'D:\Projects\APCD Kids\Data';

%macro ccc_version2_sas(dt_in,dt_out,dx,n_dxs,pc,n_pcs,icdv);
...
data temp1;
   ...
   *** procedure codes;
   ...
   if dxc(i) in: ("3180","3181","3182","330","33111","33119","3314","33189","3319","3320","3321",
          ...
          "741","742","7595","78003","9962","99663","V452","V5301","V5302") then neuromusc_ccc=1;
   ...
   else if dxc(i) in: ("32725","4162","5163","51631","51884","5190","2770","748","7704","V426",
          "V440","V4576","V460","V461","V550") then respiratory_ccc=1;

   else if dxc(i) in: ("34461","585","5964","59653","59654","753","99668","V420","V445","V446",
          "V451","V4573","V4574","V536","V555","V556","V56") then renal_ccc=1;

   else if dxc(i) in: ("4530","5364","555","556","5571","5602","5647","5714","5715","5716","5717",
          "5718","5719","7503","751","V427","V4283","V4284","V441","V442","V443","V444","V5350",
          "V5351","V5359","V551","V552","V553","V554") then GI_ccc=1;
   ...
   else if dxc(i) in: ("243","2532","2535","2536","2359","2550","25513","2552","270","271","272",
          "2750","2751","2752","2753","2772","2773","2774","2775","2776","2778","2779",
          "V4585","V5391","V6546") then metabolic_ccc=1;
          ...
          "7797") then neonatal_ccc=1;

   if dxc(i) in: ("5190","5364","9960","9961","9962","9964","99661","99662","99663","99666","99667",
          ...
          "V5359","V536","V550","V551","V552","V553","V554","V555","V556") then tech_dep_ccc=1;

   if dxc(i) in: ("99680","99681","99682","99683","99684","99685","99686","99687","99688","99689",
          "V421","V422","V426","V427","V4281","V4282","V4283","V4284","V432","V4585","V5391") then transplant_ccc=1;
   ...
   if pcc(i) in: ("0152","0153","0221","0222","0231","0232","0233","0234","0235","0239","0241",
          ...
          "3985","8945","8946","8947","8948","8949") then cvd_ccc=1;

   else if pcc(i) in: ("303","304","3121","3129","3141","3174","3241","3249","3250","3259","3321",
          "3350","3351","3352","336", "3485","9655","9723") then respiratory_ccc=1;

   else if pcc(i) in: ("3895","3927","3942","3993","3994","3995","5498","5502","5503","5504","5512",
          ...
          "5994","8607","9645","9646","9647") then renal_ccc=1;

   else if pcc(i) in: ("253","254","4210","4211","4242","4281","4311","4319","4391","4399","4412",
          ...
          "6553","6561","6563","6841","6849","6851","6859","6861","6869","6871","6879","8606") then metabolic_ccc=1;

   else if pcc(i) in: ("0010","9925") then malignancy_ccc=1;

   if pcc(i) in ("0221","0222","0231","0232","0233","0234","0235","0239","0241","0242","0293","0371",
          ...
          "8451") then tech_dep_ccc=1;

   if pcc(i) in ("3751","3350","3351","3352","336", "5561","5569","4697","5051","5059","5280","5282",
          "5283","5284","5285","5286","4100","4101","4102","4103","4104","4105","4106","4107","4108",
          "4109","4194","0091","0092","0093") then transplant_ccc=1;

   end;

   end;

   else if &icdv=10 then do;

   do i=1 to &n_dxs.;

   if dxc(i) in: ("E750","E751","E752","E754","F71","F72","F73","F842","G111","G112","G114","G118",
          ...
          "T85190A","T85192A","T85199A","T8579XA","Z982","Z4541","Z4542") then neuromusc_ccc=1;
          ...
          "Z45018","Z4502","Z4509","Z959") then cvd_ccc=1;

   else if dxc(i) in: ("E84","G4753","I2782","I43","Q30","Q31","Q32","Q33","Q34","P280","Z902","J84112",
          "J9500","J9501","J9502","J9503","J9504","J9509","9620","Z430","Z930","Z942","Z990","J95850",
          "Z9911","Z9912","T86810","T86811","T86819") then respiratory_ccc=1;

   else if dxc(i) in: ("N18","Q60","Q61","Q62","Q63","Q64","Z905","Z906","G834","N312","N319","T8571XA",
          "Z940","Z9350","Z9351","Z9352","Z9359","Z936","Z9115","Z992","Z435","Z436","Z446","Z4901",
          "Z4902","Z4931","Z4932","T8610","T8611","T8612") then renal_ccc=1;

   else if dxc(i) in: ("K50","K51","K73","K74","K754","K760","K761","K762","K763","K768","Q390","Q391",
   ...
   else if dxc(i) in: ("D841","E700","E702","E703","E704","E705","E708","E710","E711","E712","E713", 
   ...
   else if dxc(i) in: ("E343","K449","M410","M412","M4130","M418","M419","M4330","M965","Q722","Q750",
          ...
          "Q992","Q998","Q999","Q898","Q81") then congeni_genetic_ccc=1;

   else if dxc(i) in: ("C","D00","D01","D02","D03","D04","D05","D06","D07","D08","D09","D37","D38",
          "D39","D3A0","D40","D41","D42","D43","D44","D45","D46","D47","D48","D49","Q850","Z9481",
          "Z9484","T8600","T8601","T8602","T8609") then malignancy_ccc=1;

   else if dxc(i) in: ("P0501","P0511","P0502","P0512","P052","P059","P0701","P0702","P0721","P0722",
          ...
          "P578","P613","P614","P773","P832","P912") then neonatal_ccc=1;

   if dxc(i) in: ("T8509XA","T85190A","T85192A","T85199A","T8579XA","Z982","Z45441","Z45442","T82519A",
          ...
          "T84059A","T84069A","T84099A","T84498A","T84119A","T84129A","T84199A","T84498A","T8450XA",
          ...
          "T86890","T86891","T86899","T86850","T86851","T86859","T865","T86890","T86891","T86899",
          "T870X9","T871X9","T872","Y831","Y833") then tech_dep_ccc=1;
   ...
   if pcc(i) in ("0016070","0016071","0016072","0016073","0016074","0016075","0016076","0016077",
          ...
          "4B02XSZ","4B02XTZ","5A02110","5A02116","5A0211D","5A02210","5A02216","5A0221D") then cvd_ccc=1;

   else if pcc(i) in: ("0B110F4","0B110Z4","0B113F4","0B113Z4","0B114F4","0B114Z4","0B21XFZ","0BHR0MZ",
          ...
          "0CTS8ZZ","0JH604Z","0JH634Z","0JH804Z","0JH834Z","0WQ6XZ2","3E1F78Z") then respiratory_ccc=1;

   else if pcc(i) in ("031209D","031209F","03120AD","03120AF","03120JD","03120JF","03120KD","03120KF",
          ...
          "0TY00Z1","0TY00Z2","0TY10Z0","0TY10Z1","0TY10Z2","3E1K38Z","3E1M39Z","5A1D60Z") then renal_ccc=1;

   else if pcc(i) in ("0CT70ZZ","0CT7XZZ","0D11074","0D110J4","0D110K4","0D110Z4","0D113J4","0D11474",
          ...
          "3E0J7U1","3E0J8U0","3E0J8U1","3E1G78Z","3E1H78Z") then GI_ccc=1;

   else if pcc(i) in ("07TP0ZZ","07TP4ZZ","07YP0Z0","07YP0Z1","07YP0Z2","30230AZ","30230G0","30230G1",
          ...
          "30263X0","30263X1","30263Y0","30263Y1") then hemato_immu_ccc=1;

   else if pcc(i) in ("0GT00ZZ","0GT04ZZ","0GT40ZZ","0GT44ZZ","0GTK0ZZ","0GTK4ZZ","0GTR0ZZ","0GTR4ZZ",
          ...
          "0W4M070","0W4M0J0","0W4M0K0","0W4M0Z0","0W4N071","0W4N0J1","0W4N0K1","0W4N0Z1") then metabolic_ccc=1;

   else if pcc(i) in ("3E00X05","3E01305","3E02305","3E03005","3E03305","3E04005","3E04305","3E05005",
          ...
          "3E0Y705") then malignancy_ccc=1;

   if pcc(i) in ("00160J0","00160J1","00160J2","00160J4","00160J5","00160J6","00160J7","00160J8",
          ...
          "0SG04KJ","0SG04Z0","0SG04Z1","0SG04ZJ") then tech_dep_ccc=1;

   if pcc(i) in ("02YA0Z0","02YA0Z1","02YA0Z2","0BYC0Z0","0BYC0Z1","0BYC0Z2","0BYD0Z0","0BYD0Z1",
          ...
          "30263G0","30263G1","30263X0","30263X1","30263Y0","30263Y1") then transplant_ccc=1;
   ...
   drop i;
	...
	select MemberLinkEID, sum(neuromusc_ccc)>0 as neuromusc_ccc, 
		sum(cvd_ccc )>0 as cvd_ccc ,
		sum(respiratory_ccc)>0 as respiratory_ccc ,
		sum(renal_ccc)>0 as  renal_ccc,
		sum(GI_ccc)>0 as GI_ccc ,
		sum(hemato_immu_ccc)>0 as hemato_immu_ccc  ,
		sum(metabolic_ccc)>0 as metabolic_ccc ,
		sum(congeni_genetic_ccc)>0 as congeni_genetic_ccc ,
		sum(malignancy_ccc)>0 as malignancy_ccc ,
		sum(neonatal_ccc)>0 as  neonatal_ccc,
		sum(tech_dep_ccc)>0 as tech_dep_ccc,
		sum(transplant_ccc)>0 as transplant_ccc

	from temp1
	group by MemberLinkEID;
	quit;
 
    proc sort data=temp1 out=temp2 nodupkey;by MemberLinkEID;run;

data &dt_out.;
set temp2;

   num_ccc=sum(neuromusc_ccc,cvd_ccc,respiratory_ccc,renal_ccc,GI_ccc,hemato_immu_ccc,
               metabolic_ccc,congeni_genetic_ccc,malignancy_ccc,neonatal_ccc);
   ccc_flag=num_ccc>0;

   if transplant_ccc=1 then ccc_flag=1;
   if tech_dep_ccc=1 then ccc_flag=1;

run;
%mend ccc_version2_sas;
%ccc_version2_sas(dt_in=data.Kidclm2012,dt_out=data.CCC,dx=dx,n_dxs=13,pc=pc,n_pcs=7,icdv=9)
