...
if BETOS="P7A" then clm1="Oncology-Radiation Therapy";
else if BETOS="P7B" then clm1="Oncology-Other"; 
else if BETOS="O1D" then clm1="Chemotherapy"; 
else if substr(BETOS,1,2) in ("M1","M2","M3","M4","M5","M6") then clm1="Evaluation AND Management";
...
proc sort data=car&yr._2 out=data.UtilCarrier&yr.Cancer  nodupkey;by bene_id clm clm1;run;
