*****************************************
3 group comparison for QCOR conference abstract
1/30/2015
Xiner Zhou
*******************************************;
...
weight wt;
tables &q. * group /missing norow nopercent ;
run;
...
title "Q9.1";
weight wt;
tables recode_Q9_1 *group /missing norow nopercent ;
run;
 proc freq data=temp2;
title "Q9.2";
weight wt;
tables recode_Q9_2 *group/missing  norow nopercent;
run;
...
title "Q17.1";
weight wt;
tables recode_Q17_1*group /missing norow nopercent ;
run;
 proc freq data=temp2;
title "Q17.2";
weight wt;
tables recode_Q17_2*group /missing norow nopercent ;
run;
