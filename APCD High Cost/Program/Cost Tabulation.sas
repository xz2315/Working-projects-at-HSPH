...
%let bymoney=Spending;
	...
	****************high cost****************************;
proc tabulate data=APCD.AnalyticData&bymoney. noseps  QMETHOD=P2;
class highcost  type; 
...
*/
      ...
      ,Seg2011 ="Segments"*(mean*f=dollar12. median*f=dollar12. sum*f=dollar12.  )  
       Seg2011 ="Segments"*type*(mean*f=dollar12. median*f=dollar12. sum*f=dollar12.) 
	   Seg2011 ="Segments"*highcost="10% High Cost Patients"*(mean*f=dollar12. median*f=dollar12. sum*f=dollar12.) 
      All*(mean*f=dollar12. median*f=dollar12. sum*f=dollar12.  )  ;
