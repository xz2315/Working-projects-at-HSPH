...
table 
      ...
      ,highcost="10% High Cost Patients"*(mean*f=15.5 median*f=7. sum*f=20.  )  highcost="10% High Cost Patients"*type*(mean*f=15.5 median*f=7. sum*f=20.  )  
	  type*(mean*f=15.5 median*f=7. sum*f=20.  )  
