...
proc sort data=temp1;by bene_id ADMSN_DT DSCHRGDT;run;
...
********************************************************************************************;
proc sort data=temp&yr._1;by bene_id ADMSN_DT DSCHRGDT;run;
...
Title "Logistic Regression: Predicted Probability of &day. -day Readmission,Adjusting for HCC,Age,Race,Sex";
	class leadtoReadm racecat sexcat provider hcc1--hcc177 ;
...
keep provider overall&cond.Readm&day.&yr. N_Admission&cond.&day.&yr. obs&cond.&day.&yr. pred&cond&day.&yr. Adj&cond.Readm&day.&yr. Raw&cond.Readm&day.&yr.;
