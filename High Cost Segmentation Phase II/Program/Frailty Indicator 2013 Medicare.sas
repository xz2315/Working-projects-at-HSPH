*****************************************
Frailty Indicator  for Medicare 2013 (include everyone even not 20% sample)
Xiner Zhou
9/12/2016
*****************************************;
...
data rev;
set IP.Inptrev2013(keep=bene_id HCPCS_CD) 
    OP.Otptrev2013(keep=bene_id HCPCS_CD) 
    Carrier.Bcarline2013(keep=bene_id HCPCS_CD) 
    Hospice.Hspcrev2013(keep=bene_id HCPCS_CD) 
    SNF.Snfrev2013(keep=bene_id HCPCS_CD) 
    HHA.Hharev2013(keep=bene_id HCPCS_CD) 
    DME.Dmeline2013(keep=bene_id HCPCS_CD);
if HCPCS_CD in 
