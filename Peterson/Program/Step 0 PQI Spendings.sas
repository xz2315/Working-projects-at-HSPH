...
7/12/2016
************************************;
libname PQI 'D:\Projects\Scorecard\data';
...
libname mmleads 'D:\Projects\Peterson\Data';
...
set &var.;
label N_&var.=&label1.;
label &var.spending=&label2.;
proc sort nodupkey;by bene_id;
run;
%mend PQI;
%PQI(var=TAPQ01,label1="N. of Diabetes Short-Term Complications Admission",label2="Diabetes Short-Term Complications Admission");
%PQI(var=TAPQ02,label1="N. of Perforated Appendix Admission",label2="Perforated Appendix Admission");
%PQI(var=TAPQ03,label1="N. of Diabetes Long-Term Complications Admission",label2="Diabetes Long-Term Complications Admission");
%PQI(var=TAPQ05,label1="N. of Chronic Obstructive Pulmonary Disease (COPD) or Asthma in Older Adults Admission",label2="Chronic Obstructive Pulmonary Disease (COPD) or Asthma in Older Adults Admission");
%PQI(var=TAPQ07,label1="N. of Hypertension Admission",label2="Hypertension Admission");
%PQI(var=TAPQ08,label1="N. of Heart Failure Admission",label2="Heart Failure Admission");
%PQI(var=TAPQ10,label1="N. of Dehydration Admission",label2="Dehydration Admission");
%PQI(var=TAPQ11,label1="N. of Bacterial Pneumonia Admission",label2="Bacterial Pneumonia Admission");
%PQI(var=TAPQ12,label1="N. of Urinary Tract Infection Admission",label2="Urinary Tract Infection Admission");
%PQI(var=TAPQ13,label1="N. of Angina Without Procedure Admission",label2="Angina Without Procedure Admission");
%PQI(var=TAPQ14,label1="N. of Uncontrolled Diabetes Admission",label2="Uncontrolled Diabetes Admission");
%PQI(var=TAPQ15,label1="N. of Asthma in Younger Adults Admission",label2="Asthma in Younger Adults Admission");
%PQI(var=TAPQ16,label1="N. of Lower-Extremity Amputation among Patients with Diabetes",label2="Lower-Extremity Amputation among Patients with Diabetes");
%PQI(var=TAPQ90,label1="N. of Prevention Quality Overall",label2="Prevention Quality Overall");
%PQI(var=TAPQ91,label1="N. of Prevention Quality Acute",label2="Prevention Quality Acute");
%PQI(var=TAPQ92,label1="N. of Prevention Quality Chronic",label2="Prevention Quality Chronic");
...
array try {32} N_TAPQ01 TAPQ01Spending 
